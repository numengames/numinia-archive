...
# virtual-worlds/ — experiences inside Numinia's 3D spaces

What a player does inside the virtual worlds: spaces, portals, escape rooms,
seals and rewards. No Game Director and no dice: the space itself sets the
challenge, and a guide such as Senet, the Game Master, welcomes the player.
