...
| Folder | What | Read by |
|---|---|---|
| `game/` | The rules. `manual-v0.6.0.md` is the canonical text of the RPG (source of numinia.com's domain model and the Codex); `attributes-and-ranks.md` the compendium. | numinia.com Codex (`scripts/fetch-lore.mjs`), Senet, `SYS-003` |
