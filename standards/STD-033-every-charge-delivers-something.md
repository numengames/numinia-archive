...
before payment. None is called a donation.

**The whole price.** The price shown MUST be final, tax included, with
nothing added at the last step, so the buyer can compare before paying.
Once our sales to consumers elsewhere in Europe pass ten thousand euros a
year, each buyer's country sets the tax, declared through the European
one-stop shop.

**No record, no charge.** Everything on sale MUST have a record in the
archive giving what it delivers, its price with tax, its period, its site
and its state. Sites read the price from that record.

**One account, the Oracle's keys.** Every payment MUST be collected in Numen
Games' account. Only an Oracle creates products, prices or payment links.
...
a short self-assessment. It also leaves the strong authentication that
European payment law asks for to the payment company.
...
Every charge becomes a line in the one account, which has its own standard.
...
| PAY-007 | Remembered by choice | law: [GDPR, Regulation (EU) 2016/679](https://eur-lex.europa.eu/eli/reg/2016/679/oj) arts. 6(1)(a), 7(3), 25(2) | by hand, in every pull request that touches a charge |
...
A charge that is not written down becomes a favour asked of someone who
cannot see where the money goes. Written rules let every payer know what they
buy, what it costs and how to stop.
