...
- head: `66c527c`  · corpus_hash: `1d2b8ecc9ae17be4…`  · measured_at: 2026-09-20T16:45:05Z  · root_dirty: 0

## corpus

| key | value | unit | definition |
|---|---|---|---|
| `corpus.files_total` | 494 | files | `git ls-files` at HEAD, every path |
...
| `corpus.scripts_total` | 34 | files | files under `machine/scripts/` with a code extension (.py .mjs .js .sh .ts) |
