...
- head: `4ff9054+index`  · corpus_hash: `2fa31d243f1996c6…`  · measured_at: 2026-09-22T15:21:44Z  · root_dirty: 0

## corpus

| key | value | unit | definition |
|---|---|---|---|
| `corpus.files_total` | 507 | files | `git ls-files` at HEAD, every path |
...
| `corpus.scripts_total` | 41 | files | files under `machine/scripts/` with a code extension (.py .mjs .js .sh .ts) |
...
| `tokens.total` | 619216 | tokens | Σ tokens over the corpus (every tracked .md outside web/, whole file, frontmatter included) |
