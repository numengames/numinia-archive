...
- head: `3fd817b`  · corpus_hash: `2494e4ce32f2cb64…`  · measured_at: 2026-09-20T18:00:48Z  · root_dirty: 0

## corpus

| key | value | unit | definition |
|---|---|---|---|
| `corpus.files_total` | 497 | files | `git ls-files` at HEAD, every path |
