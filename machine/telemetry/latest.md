...
- head: `ecd0846`  · corpus_hash: `652265374a14bf56…`  · measured_at: 2026-09-25T09:13:27Z  · root_dirty: 0

## corpus

| key | value | unit | definition |
|---|---|---|---|
| `corpus.files_total` | 591 | files | `git ls-files` at HEAD, every path |
...
| `tokens.total` | 861427 | tokens | Σ tokens over the corpus (every tracked .md outside web/, whole file, frontmatter included) |
