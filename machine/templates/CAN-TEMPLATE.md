...
# ANSWER THE THREE ADMISSION QUESTIONS AT THE END BEFORE YOU WRITE A LINE.
id: "CAN-NNN"
uid: ""
...
<!-- Everything above this line is required and is read by the site and by
     every agent. Everything below it is yours: write the text. -->
...
THE THREE ADMISSION QUESTIONS. Answer before writing:
  ...
  1. Did we DECIDE this, or are we DESCRIBING it?
     Described → `system/`. Canon is not a manual of how the machine works.
