...
//
//   node machine/scripts/entities.mjs          walks both, writes objects/catalogue.json
//                                      (what numinia.com reads — header data only,
//                                      never the body)
//   node machine/scripts/entities.mjs --check  also fetches every copy of every form,
...
const catalogue = {
  $comment: 'Generated by machine/scripts/entities.mjs from objects/*.md — do not edit. The cards are the source; this is the index numinia.com reads. Bytes live in the copies, never here. Undated on purpose: it is a pure function of the cards, so the same cards give the same file at any commit; the dated artefact is CHECK.md.',
  entities,
};
