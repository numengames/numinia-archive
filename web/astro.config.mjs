...
export default defineConfig({
	...
	redirects: {
		...
		"/diseno": "/design",
		"/standards/engineering-standards": "/standards/std-005-when-a-rule-bites",
		...
		"/standards/std-011-external-standards": "/standards/std-005-when-a-rule-bites",
		...
		"/standards/std-005-engineering-standards": "/standards/std-005-when-a-rule-bites",
		...
		// STD-005 renamed to its question; STD-032 reshelved as SYS-009, a map not a rule (2026-09-26)
		"/standards/std-005-engineering-baseline": "/standards/std-005-when-a-rule-bites",
