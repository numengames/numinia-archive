...
49 rule documents; 7 are registers and take their scope from the standard that cites them; 1 are canon, which state why rather than whom; every other document names whom it binds.
<!-- rule-index:end -->
